...
Leaderboards for machine-payable APIs rank by claimed volume, which is easy to inflate —
...
estimates — the [methodology](https://apeirontrade.github.io/provenance-site/methodology.html)
